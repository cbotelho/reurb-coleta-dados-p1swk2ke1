-- Script para inserir usuários a partir da linha 67 (Gessyca Barreiros)
-- Continuação do populate_users_fixed.sql
...
-- Verificar usuários inseridos a partir da linha 67
SELECT 
    nome_usuario,
    nome,
    sobrenome,
    ...
    created_at
FROM reurb_profiles 
WHERE created_at >= '2025-11-04 15:50:00'
