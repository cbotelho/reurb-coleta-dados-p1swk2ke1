-- Script limpo para popular tabela reurb_profiles
-- Sem caracteres especiais ou problemas de codificação
...
-- Usuario 16: Gessyca Barreiros
(gen_random_uuid(), 'SEHAB', 'gessyca.barreiros', 'Gessyca', 'Karinne Picanco', 'Barreiros', 'gessyca.ka@gmail.com', NULL, '2025-11-06 05:34:00', 'Ativo', 'Carlos Botelho', '2025-11-04 15:50:00'),

-- Usuario 17: Ivana Neves
...
-- Usuario 20: José Ubirajara
(gen_random_uuid(), 'Tecnicos Amapa Terra', 'jose.ubirajara', 'Jose Ubirajara', 'Malao Junior', 'juniormalvao@gmail.com', 'user_3_1760981257.png', '2025-10-27 09:20:00', 'Ativo', 'Carlos Botelho', '2025-10-20 14:27:00'),

-- Usuario 21: Jussara Amanajás
(gen_random_uuid(), 'SEHAB', 'jussara.amanajas', 'Jussara', 'da Silva Tavares', 'Amanajas', 'jdasilvatavares@gmail.com', 'user_22_1762764266.png', '2026-01-05 10:12:00', 'Ativo', 'Victoria Reis Carvalho', '2025-11-04 15:45:00'),

-- Usuario 22: Karla Lobato
...
-- Usuario 23: Karlla Jesus
(gen_random_uuid(), 'Tecnicos Amapa Terra', 'karlla.jesus', 'Karlla Tatiane de', 'Jesus', 'karllatatianne40@gmail.com', 'user_6_1760981787.png', NULL, '2025-10-20 14:36:00', 'Ativo', 'Carlos Botelho', '2025-10-20 14:36:00'),

-- Usuario 24: Luciana Sousa
...
-- Usuario 26: Manoel Ferreira
(gen_random_uuid(), 'Tecnicos Amapa Terra', 'manoel.ferreira', 'Manoel Martinho T.', 'Ferreira', 'martinho-ap4@hotmail.com', 'user_7_1761665345.png', '2026-01-06 11:35:00', 'Ativo', 'Carlos Botelho', '2025-10-20 14:38:00'),

-- Usuario 27: Marcilene Guimarães
...
-- Usuario 29: Michell Cardoso
(gen_random_uuid(), 'Tecnicos Amapa Terra', 'michell.cardoso', 'Michell Gleison', 'Sales Cardoso', 'michell.gleison.cardoso@gmail.com', 'user_8_1761840467.png', '2026-01-06 10:50:00', 'Ativo', 'Carlos Botelho', '2025-10-20 14:41:00'),

-- Usuario 30: Naldo Rocha
...
-- Usuario 31: Neuriani Santos
(gen_random_uuid(), 'Tecnicos Amapa Terra', 'neuriani.santos', 'Neuriani Monte dos', 'Santos', 'nmonte667@gmail.com', 'user_4_1760981484.png', '2026-01-06 08:50:00', 'Ativo', 'Carlos Botelho', '2025-10-20 14:31:00'),

-- Usuario 32: Ozi Araujo
...
-- Usuario 34: Raphael Farias
(gen_random_uuid(), 'Tecnicos Amapa Terra', 'raphael.farias', 'Raphael Neves de', 'Farias', 'raphaelneves250@gmail.com', 'user_5_1760981675.png', '2025-10-21 19:58:00', 'Ativo', 'Carlos Botelho', '2025-10-20 14:34:00'),

-- Usuario 35: Raquely Torres
...
-- Usuario 38: Rosimeire Peretti
(gen_random_uuid(), 'SEHAB', 'rosimeire.peretti', 'Rosimeire', 'Dias de Mendonca', 'Peretti', 'rosedperetti@gmail.com', NULL, '2026-01-07 12:41:00', 'Ativo', 'Carlos Botelho', '2025-11-04 15:22:00'),

-- Usuario 39: Samilly Barbosa
